...
Data<-scale(read.csv(file ="Approach_II/MSSA_Work/W63_variables_set.csv",header = TRUE)[-1])
head(Data)

L=156 #Assume window length close to N/2 (N=222 here)
#Create a ssa object
...
dev.copy(png,file = "Approach_II/MSSA_Work/Eigenvectors_MSSA_W63.png")
dev.off()
...
dev.copy(png,file = "Approach_II/MSSA_Work/Screeplot_MSSA_W63.png")
dev.off()
...
dev.copy(png,file = "Approach_II/MSSA_Work/Wcor_MSSA_W63.png")
dev.off()
...
r <- reconstruct(s,groups = list(c(1,2),c(3,4),c(5,6),c(7,8),c(9,10),c(11,12),c(13),c(14,15,17,18,19),c(16)))

wellNo <- c("W60","W63","W67","W70","W73","W74","W78","W80","W81","W115","W116","W118")

for (i in 1:length(r)) {
  write.csv(r[i],file=paste0("Approach_II/MSSA_Work/",wellNo[2],"_RC",
