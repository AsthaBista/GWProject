...
This is the data containing data from the subgroup containing W60 well. This data is then used for MSSA operation, for which guidance from [@golyandina2013multivariate] and [@hassani2013multivariate] were taken. Rssa package [@Rssa2015] was used for multivariate singular spectrum analysis (MSSA).
